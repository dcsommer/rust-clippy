...
/// The source ranges covered by test code, sorted and non-overlapping. This exists to support
/// early pass lints when `allow-in-tests` is set; see [`set_test_code_spans`].
